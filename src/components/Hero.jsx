  ...
  return (
    <section className="relative w-full min-h-screen pt-28 pb-16 mx-auto flex items-center justify-center bg-[#050816] overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
        ...
        <div className="lg:col-span-7 flex flex-col items-start">
          ...
          <h1 className="text-4xl sm:text-6xl font-extrabold text-white tracking-tight leading-none mb-4">
            Hi, I'm{" "}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#915eff] via-purple-400 to-indigo-400">
              Bilal Ahmed
            </span>
          </h1>
          ...
          <p className="text-secondary text-base sm:text-lg max-w-2xl leading-relaxed mb-8">
            I build responsive, scalable web applications with modern frontend
            technologies, robust backend APIs, database integration,
            authentication, and AI-powered features.
          </p>
      ...
      <div className="absolute bottom-4 left-1/2 -translate-x-1/2 hidden md:flex flex-col items-center">
        <a
          href="#projects"
          className="flex flex-col items-center gap-2 text-xs text-secondary hover:text-white transition"
        >
